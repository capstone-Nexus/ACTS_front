...
export default function SurveyCard({ title, selected, onSelect }: SurveyCardProps) {
  ...
  return (
    <div className="w-full h-[150px] bg-[#F8FBFF] rounded-[20px] flex flex-col items-center justify-between p-[20px] mt-[40px]">
        ...
        <div className="w-full h-[45px] flex flex-row items-center justify-center gap-[100px]">
          {[1, 2, 3, 4, 5, 6].map(num => (
            <div
              ...
              ${selected === num ? 'border-none bg-gradient-to-r from-[#59C0EE] to-[#4E59F4]' : 'border-[#D2D2D2] bg-white'}`}
            >
