...
export default function Test4() {
    ...
    return (
        <div className="w-full h-screen flex justify-center items-center">
            분할 주의력 검사 페이지
           <Link href="/cat/test5" className="mt-11 w-[90px] h-[50px] flex justify-center items-center bg-[#4A8AEE] cursor-pointer border-2 border-transparent hover:border-[#4A8AEE] hover:bg-white duration-200 group">
