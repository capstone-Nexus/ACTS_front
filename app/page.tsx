...
export const metadata = {
  title: "ACTS - ADHD 검사 및 AI 상담 서비스",
  description: "ACTS는 과학적이고 정확한 ADHD 자가진단을 위한 종합적인 테스트와 개인화된 AI 상담 서비스를 제공합니다.",
};
...
export default function Home() {
  ...
  return (
    <>
      <MainHeader />
      <Image src={Dotbogi} alt="backgroundimg" className="fixed z-[-1] pro" />
